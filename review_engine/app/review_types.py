...
(``icon`` is an emoji-free glyph name from :mod:`review_engine.app.icons`, RAYAAAA-269)
and a hex accent used by the dashboard cards. Kept UI-agnostic (no Streamlit
import) so both surfaces — and tests — can import it.
"""
...
REVIEW_TYPES: list[ReviewType] = [
    ReviewType("legal_case", "Legal Case Analysis", "Case file review", "scales", "#3b82f6"),
    ReviewType("hr_termination", "HR & Termination Review", "Termination letter compliance", "users", "#f59e0b"),
    ReviewType("contract", "Contract Review", "Vendor contracts", "contract", "#8b5cf6"),
    ReviewType("compliance_audit", "Compliance Audit", "HIPAA compliance", "check", "#10b981"),
    ReviewType("incident_misconduct", "Incident & Misconduct Review", "Workplace incidents", "alert", "#ef4444"),
    ReviewType("general_document", "General Document Review", "Policy Q&A", "document", "#64748b"),
]
